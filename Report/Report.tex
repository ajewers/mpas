...
\bibitem{BeatDetection} GameDev. \textit{Beat Detection Algorithms},  archive.gamedev.net. [Online]. Available: http://archive.gamedev.net/archive/reference/programming/features/beatdetection/ [Accessed: Apr. 17, 2017]
\end{thebibliography}
